    ...
    */
    ...
    public Connection connectToDb(){
        ...
        try{
            ...
            conn = DriverManager.getConnection("jdbc:postgresql://localhost:5433/" + "DiscordBot", "postgres", System.getenv("password"));
    ...
    public void createTable(Connection conn){
        ...
        try{
            ...
            statement.executeUpdate(query); // jdbc taking query string and creating a statement that postgres can execute
